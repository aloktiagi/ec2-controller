...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/TransitGatewayConnect"
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.TransitGatewayConnect{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.TransitGatewayConnect),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.TransitGatewayConnect{}),
	}
