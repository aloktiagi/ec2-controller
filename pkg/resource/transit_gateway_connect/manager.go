...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=transitgatewayconnects,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=transitgatewayconnects/status,verbs=get;update;patch
