...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=networkinsightspaths,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=networkinsightspaths/status,verbs=get;update;patch
