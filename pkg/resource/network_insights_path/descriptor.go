...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/NetworkInsightsPath"
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.NetworkInsightsPath{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.NetworkInsightsPath),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.NetworkInsightsPath{}),
	}
