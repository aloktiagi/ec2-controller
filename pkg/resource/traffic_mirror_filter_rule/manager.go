...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=trafficmirrorfilterrules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=trafficmirrorfilterrules/status,verbs=get;update;patch
