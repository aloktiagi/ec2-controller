...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/TrafficMirrorFilterRule"
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.TrafficMirrorFilterRule{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.TrafficMirrorFilterRule),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.TrafficMirrorFilterRule{}),
	}
