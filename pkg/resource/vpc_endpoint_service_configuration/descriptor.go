...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/VPCEndpointServiceConfiguration"
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.VPCEndpointServiceConfiguration{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.VPCEndpointServiceConfiguration),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.VPCEndpointServiceConfiguration{}),
	}
