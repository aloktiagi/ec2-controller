...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=clientvpnroutes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=clientvpnroutes/status,verbs=get;update;patch
