...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=vpcendpointconnectionnotifications,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=vpcendpointconnectionnotifications/status,verbs=get;update;patch
