...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/VPCEndpointConnectionNotification"
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.VPCEndpointConnectionNotification{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.VPCEndpointConnectionNotification),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.VPCEndpointConnectionNotification{}),
	}
