...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=transitgatewayprefixlistreferences,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=transitgatewayprefixlistreferences/status,verbs=get;update;patch
