...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=reservedinstanceslistings,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=reservedinstanceslistings/status,verbs=get;update;patch
