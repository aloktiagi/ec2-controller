...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/ReservedInstancesListing"
)

var (
	resourceGK = metav1.GroupKind{
		Group: "ec2.services.k8s.aws",
		Kind:  "ReservedInstancesListing",
	}
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.ReservedInstancesListing{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ReservedInstancesListing),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.ReservedInstancesListing{}),
	}
