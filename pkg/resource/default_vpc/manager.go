...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=defaultvpcs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=defaultvpcs/status,verbs=get;update;patch
