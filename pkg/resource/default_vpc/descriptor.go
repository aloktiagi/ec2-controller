...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/DefaultVPC"
)
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.DefaultVPC{}),
	}
