...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=defaultsubnets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=defaultsubnets/status,verbs=get;update;patch
