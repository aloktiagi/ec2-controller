...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/TransitGatewayConnectPeer"
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.TransitGatewayConnectPeer{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.TransitGatewayConnectPeer),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.TransitGatewayConnectPeer{}),
	}
