...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=transitgatewayconnectpeers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=transitgatewayconnectpeers/status,verbs=get;update;patch
