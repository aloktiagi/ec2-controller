...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/FPGAImage"
)
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.FPGAImage{}),
	}
