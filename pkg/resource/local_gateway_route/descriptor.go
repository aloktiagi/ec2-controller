...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/LocalGatewayRoute"
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.LocalGatewayRoute{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.LocalGatewayRoute),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.LocalGatewayRoute{}),
	}
