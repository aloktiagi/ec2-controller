...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=localgatewayroutes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=localgatewayroutes/status,verbs=get;update;patch
