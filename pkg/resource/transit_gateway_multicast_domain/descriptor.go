...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/TransitGatewayMulticastDomain"
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.TransitGatewayMulticastDomain{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.TransitGatewayMulticastDomain),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.TransitGatewayMulticastDomain{}),
	}
