...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=transitgatewaymulticastdomains,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=transitgatewaymulticastdomains/status,verbs=get;update;patch
