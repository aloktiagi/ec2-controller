...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=capacityreservations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=capacityreservations/status,verbs=get;update;patch
