...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=clientvpnendpoints,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=clientvpnendpoints/status,verbs=get;update;patch
