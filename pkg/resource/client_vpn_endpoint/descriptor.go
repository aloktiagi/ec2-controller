...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/ClientVPNEndpoint"
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.ClientVPNEndpoint{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ClientVPNEndpoint),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.ClientVPNEndpoint{}),
	}
