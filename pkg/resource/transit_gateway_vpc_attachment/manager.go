...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=transitgatewayvpcattachments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=transitgatewayvpcattachments/status,verbs=get;update;patch
