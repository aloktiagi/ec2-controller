...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=spotdatafeedsubscriptions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=spotdatafeedsubscriptions/status,verbs=get;update;patch
