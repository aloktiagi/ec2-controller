...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/SpotDatafeedSubscription"
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.SpotDatafeedSubscription{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.SpotDatafeedSubscription),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.SpotDatafeedSubscription{}),
	}
