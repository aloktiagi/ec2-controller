...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=internetgateways,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=internetgateways/status,verbs=get;update;patch
