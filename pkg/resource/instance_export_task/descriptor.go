...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/InstanceExportTask"
)

var (
	resourceGK = metav1.GroupKind{
		Group: "ec2.services.k8s.aws",
		Kind:  "InstanceExportTask",
	}
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.InstanceExportTask{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.InstanceExportTask),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.InstanceExportTask{}),
	}
