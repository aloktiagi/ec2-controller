...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=trafficmirrorsessions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=trafficmirrorsessions/status,verbs=get;update;patch
