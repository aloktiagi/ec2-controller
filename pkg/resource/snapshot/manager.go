...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=snapshots,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=snapshots/status,verbs=get;update;patch
