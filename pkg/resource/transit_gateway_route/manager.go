...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=transitgatewayroutes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=transitgatewayroutes/status,verbs=get;update;patch
