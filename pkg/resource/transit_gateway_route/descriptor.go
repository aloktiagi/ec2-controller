...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/TransitGatewayRoute"
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.TransitGatewayRoute{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.TransitGatewayRoute),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.TransitGatewayRoute{}),
	}
