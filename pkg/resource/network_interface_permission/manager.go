...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=networkinterfacepermissions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=networkinterfacepermissions/status,verbs=get;update;patch
