...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/NetworkInterfacePermission"
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.NetworkInterfacePermission{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.NetworkInterfacePermission),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.NetworkInterfacePermission{}),
	}
