...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=images,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=images/status,verbs=get;update;patch
