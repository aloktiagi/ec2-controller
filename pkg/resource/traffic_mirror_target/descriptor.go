...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/TrafficMirrorTarget"
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.TrafficMirrorTarget{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.TrafficMirrorTarget),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.TrafficMirrorTarget{}),
	}
