...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=trafficmirrortargets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=trafficmirrortargets/status,verbs=get;update;patch
