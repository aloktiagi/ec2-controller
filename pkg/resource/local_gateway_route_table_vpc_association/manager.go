...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=localgatewayroutetablevpcassociations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=localgatewayroutetablevpcassociations/status,verbs=get;update;patch
