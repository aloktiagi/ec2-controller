...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/LocalGatewayRouteTableVPCAssociation"
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.LocalGatewayRouteTableVPCAssociation{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.LocalGatewayRouteTableVPCAssociation),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.LocalGatewayRouteTableVPCAssociation{}),
	}
