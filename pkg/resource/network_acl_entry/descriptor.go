...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/NetworkACLEntry"
)

var (
	resourceGK = metav1.GroupKind{
		Group: "ec2.services.k8s.aws",
		Kind:  "NetworkACLEntry",
	}
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.NetworkACLEntry{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.NetworkACLEntry),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.NetworkACLEntry{}),
	}
