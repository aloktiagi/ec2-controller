...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=networkaclentries,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=networkaclentries/status,verbs=get;update;patch
