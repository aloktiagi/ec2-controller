...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=trafficmirrorfilters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=trafficmirrorfilters/status,verbs=get;update;patch
