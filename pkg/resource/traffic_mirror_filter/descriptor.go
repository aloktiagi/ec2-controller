...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/TrafficMirrorFilter"
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.TrafficMirrorFilter{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.TrafficMirrorFilter),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.TrafficMirrorFilter{}),
	}
