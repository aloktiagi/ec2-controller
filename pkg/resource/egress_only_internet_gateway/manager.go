...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=egressonlyinternetgateways,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=egressonlyinternetgateways/status,verbs=get;update;patch
