...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/EgressOnlyInternetGateway"
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.EgressOnlyInternetGateway{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.EgressOnlyInternetGateway),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.EgressOnlyInternetGateway{}),
	}
