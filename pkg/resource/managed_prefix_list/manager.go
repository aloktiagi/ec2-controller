...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=managedprefixlists,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=managedprefixlists/status,verbs=get;update;patch
