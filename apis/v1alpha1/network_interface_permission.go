...
// NetworkInterfacePermission is the Schema for the NetworkInterfacePermissions API
// +kubebuilder:object:root=true
// +kubebuilder:subresource:status
type NetworkInterfacePermission struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              NetworkInterfacePermissionSpec   `json:"spec,omitempty"`
	Status            NetworkInterfacePermissionStatus `json:"status,omitempty"`
}

// NetworkInterfacePermissionList contains a list of NetworkInterfacePermission
// +kubebuilder:object:root=true
